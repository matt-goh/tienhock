...
export default function (pool) {
  ...
  router.get("/all-mappings", async (req, res) => {
    ...
    `;
      ...
      const mappingQuery = `
        ...
        JOIN jellypolly.pay_codes pc ON jpc.pay_code_id = pc.id
  ...
  router.post("/", async (req, res) => {
    ...
    try {
      ...
      const checkQuery =
        "SELECT 1 FROM jellypolly.job_pay_codes WHERE job_id = $1 AND pay_code_id = $2";
  ...
  router.put("/:jobId/:payCodeId", async (req, res) => {
    ...
    try {
      ...
      const query = `
      UPDATE jellypolly.job_pay_codes
  ...
  router.delete("/:jobId/:payCodeId", async (req, res) => {
    ...
    try {
      ...
      const query = `
      DELETE FROM jellypolly.job_pay_codes
