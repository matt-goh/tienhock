  ...
  router.post("/", async (req, res) => {
    ...
    try {
      ...
      if (!invoice_id || !payment_date || !amount_paid || !payment_method) {
        throw new Error("Missing required fields: invoice_id, payment_date, amount_paid, payment_method");
      }
      ...
      const newBalanceDue = Math.max(0, parseFloat(invoice.balance_due) - parseFloat(amount_paid));
