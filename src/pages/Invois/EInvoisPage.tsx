  ...
  return (
    <div className="flex flex-col px-6 py-4">
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-3xl font-semibold text-default-900">e-Invois Records</h1>
        <Button
      ...
      <div className="border rounded-lg overflow-hidden">
        <div className="relative">
          <div className={`bg-default-100 border-b ${hasScrollbar ? "pr-[17px]" : ""}`}>
            <table className="w-full table-fixed">
              ...
              <thead>
                <tr>
                  <th className="px-6 py-3 text-left font-medium text-default-700">Invoice No</th>
                  <th className="px-6 py-3 text-left font-medium text-default-700">Type</th>
                  <th className="px-6 py-3 text-left font-medium text-default-700">Customer</th>
                  <th className="px-6 py-3 text-left font-medium text-default-700">Validated At</th>
                  <th className="px-6 py-3 text-right font-medium text-default-700">Amount</th>
                  <th className="px-6 py-3 text-left font-medium text-default-700">Submission ID</th>
                </tr>
              </thead>
            </table>
          </div>
            ...
            <table className="w-full table-fixed">
              ...
              <tbody className="bg-white">
                {loading ? (
                  ...
                  <tr>
                    <td colSpan={6} className="px-6 py-3 text-center text-default-500">
                      No e-invoices found
                    </td>
                  </tr>
                ) : (
                  einvoices.map((einvoice) => (
                    <tr key={einvoice.uuid} className="border-b last:border-0">
                      ...
                      <td className="px-6 py-3 text-default-700 text-right">
