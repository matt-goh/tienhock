        ...
        <div className="flex flex-col md:flex-row items-stretch md:items-center space-y-3 md:space-y-0 md:space-x-3 mt-4 md:mt-0 w-full md:w-auto">
          ...
          <div className="relative flex-grow">
            ...
            <input
              type="text"
              placeholder="Search..."
              className="pl-10 pr-4 py-2 border border-default-300 dark:border-gray-600 bg-white dark:bg-gray-900/50 text-default-900 dark:text-gray-100 placeholder:text-default-400 dark:placeholder:text-gray-400 rounded-full focus:outline-none focus:border-default-500 dark:focus:border-gray-500"
              value={searchTerm}
