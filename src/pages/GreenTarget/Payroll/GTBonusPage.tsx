// src/pages/GreenTarget/Payroll/GTBonusPage.tsx
// Green Target Bonus entry page. Same flow as the Tien Hock Bonus page but
// scoped to GT payroll employees and greentarget.commission_records
