// src/pages/GreenTarget/Payroll/GTOthersKerjaLuarOtPage.tsx
// Green Target Others (Kerja Luar OT) entry page. Same flow as the Tien Hock
...
const GTOthersKerjaLuarOtPage: React.FC = () => {
  ...
  const fetchRecords = async (): Promise<void> => {
    setIsLoading(true);
    try {
      const url = `${API_BASE}?year=${currentYear}&month=${currentMonth}`;
...
export default GTOthersKerjaLuarOtPage;
