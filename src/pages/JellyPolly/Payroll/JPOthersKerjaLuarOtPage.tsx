// src/pages/JellyPolly/Payroll/JPOthersKerjaLuarOtPage.tsx
// Jelly Polly Others (Kerja Luar OT) entry page. Same flow as the Tien Hock
// page but scoped to JP payroll employees and jellypolly.others_records.
...
const API_BASE = "/jellypolly/api/others-records";
          ...
          <div className="flex w-full flex-wrap items-center justify-end gap-3 md:w-auto">
            <div className="relative w-full sm:w-80">
              ...
              <input
                ...
                placeholder={t(
                  "Search name, pay code, date, amount, description..."
                )}
...
export default JPOthersKerjaLuarOtPage;
