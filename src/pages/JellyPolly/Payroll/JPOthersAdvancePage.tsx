// src/pages/JellyPolly/Payroll/JPOthersAdvancePage.tsx
// Jelly Polly Others (Advance) entry page. Same flow as the Tien Hock
// Others (Advance) page but scoped to JP payroll employees and
// jellypolly.commission_records (is_advance = true = raises gross, then
...
export default JPOthersAdvancePage;
