...
interface JPMonthlyLogEntryPageProps {
  mode?: "create" | "edit";
  existingWorkLog?: any;
  onCancel?: () => void;
  jobType?: string;
...
const JPMonthlyLogEntryPage: React.FC<JPMonthlyLogEntryPageProps> = ({
  mode = "create",
  existingWorkLog,
  onCancel,
  jobType = "MAINTENANCE",
    ...
    const fetchLeaveRecords = async () => {
      ...
      try {
        ...
        const response = await api.get(
          `/jellypolly/api/monthly-work-logs/leave/${formData.logYear}/${formData.logMonth}?section=${section}`,
        );
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Leave Records Section (shared ledger, company=JP) */}
      {JP_LEAVE_ENABLED && (
      <div className="bg-white dark:bg-gray-800 rounded-lg border border-default-200 dark:border-gray-700">
...
export default JPMonthlyLogEntryPage;
