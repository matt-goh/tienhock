...
const FILTERS_STORAGE_KEY = "jpStaffList";
const SCROLL_RESTORATION_KEY = "jp-staff-list";
...
const EmployeeCard = ({
  ...
  const handleClick = () => {
    navigate(`/jellypolly/catalogue/staff/${employee.id}`);
  };
  ...
  const handleEditClick = (e: React.MouseEvent) => {
    e.preventDefault();
    e.stopPropagation();
    navigate(`/jellypolly/catalogue/staff/${employee.id}/edit`);
  };
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="flex gap-3">
            ...
            />
            <Button
              onClick={() => navigate("/jellypolly/catalogue/staff/new")}
              icon={IconPlus}
              color="sky"
            >
              {t("Add Staff")}
