// src/utils/JellyPolly/useJPEffectiveRates.ts — JP effective-rate overlay (jellypolly.pay_rate_schedules)
...
export const useJPEffectiveRates = () => {
    ...
    async (
      ...
      try {
        const map: Record<string, EffectiveRate> = await api.post(
          "/jellypolly/api/pay-rate-schedules/resolve",
