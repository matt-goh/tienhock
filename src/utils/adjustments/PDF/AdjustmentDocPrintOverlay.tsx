// src/utils/adjustments/PDF/AdjustmentDocPrintOverlay.tsx
...
const AdjustmentDocPrintOverlay = ({
  docs,
  onComplete,
}: {
  ...
  useEffect(() => {
    ...
    // onComplete intentionally excluded — parent typically passes an inline
    // arrow which would otherwise re-fire the effect and trigger a second
    // print job mid-flow.
...
export default AdjustmentDocPrintOverlay;
