...
> = ({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success(
        t('Pay code "{{description}}" updated - Added: {{added}}, Removed: {{removed}} job(s)', {
      ...
      setError(err.message || t("Failed to update job associations"));
      toast.error(t("Failed to update job associations"));
    } finally {
      setIsSaving(false);
    }
  };
