...
const CHANGELOG_ENTRIES: ChangelogEntry[] = [
  {
    date: "2026-07-22",
    ms: "Susunan produk kini boleh diubah dan dikongsi oleh semua pengguna: klik butang Reorder di halaman Catalogue → Product, Production Entry atau Stock Movement, pilih jenis produk (Mee, Bihun, Bundle, Other atau Jelly Polly), seret produk mengikut susunan yang dikehendaki dan simpan. Susunan ini digunakan di semua halaman produk dan pengeluaran — pemilihan Production Entry, Product Stock, Production Records dan kotak carian produk. Susunan asal produk Mee: 1-350G, 1-3UDG, 1-2UDG, 1-MNL.",
    en: "Product ordering is now adjustable and shared by all users: click the Reorder button on the Catalogue → Product, Production Entry or Stock Movement page, pick a product type (Mee, Bihun, Bundle, Other or Jelly Polly), drag the products into the desired order and save. This order is used across all product and production pages — the Production Entry selection, Product Stock, Production Records and the product search boxes. Initial Mee product order: 1-350G, 1-3UDG, 1-2UDG, 1-MNL.",
  },
  {
    date: "2026-07-22",
