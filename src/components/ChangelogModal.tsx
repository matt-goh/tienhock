...
const CHANGELOG_ENTRIES: ChangelogEntry[] = [
  ...
  {
    date: "2026-07-20",
    ms: "Kiraan hari bekerja untuk kadar OT (Julai 2026 dan seterusnya) telah dibetulkan bagi pekerja yang memegang dua jawatan di bawah dua ID staf, contohnya kerja harian yang direkod dalam log kerja harian dan kerja bungkusan yang direkod sebagai pengeluaran. Sebelum ini tarikh pengeluaran menambah hari bekerja tambahan, jadi pembahagi menjadi terlalu besar dan kadar OT terlalu rendah. Mulai kini, jika pekerja mempunyai log kerja harian pada bulan tersebut, hanya tarikh log kerja harian dikira sebagai hari bekerja; pendapatan bungkusan tetap dikira penuh tetapi tidak lagi menambah hari. Pekerja bungkusan yang tiada log kerja harian langsung tidak berubah. Sila proses semula gaji Julai 2026 untuk melihat kadar OT yang dikemas kini.",
    en: "The worked-day count used for the OT rate (July 2026 onwards) has been corrected for staff who hold two jobs under two staff IDs, for example daily work recorded on a daily work log plus packing recorded as production. Production dates previously added extra worked days, which made the divisor too large and the OT rate too low. From now on, if a worker has any daily work log for the month, only the daily work log dates count as worked days; packing earnings still count in full but no longer add days. Packing staff with no daily work log at all are unaffected. Please reprocess the July 2026 payroll to see the updated OT rates.",
  },
  {
    date: "2026-07-20",
  ...
  {
    date: "2026-07-19",
    ms: "Mulai bulan gaji Julai 2026, kadar kerja lebih masa (OT) dikira secara automatik daripada pendapatan bulan itu sendiri, mengikut Akta Kerja 1955, untuk ketiga-tiga syarikat (Tien Hock, Green Target, Jelly Polly). Kiraan: gaji + insentif/komisen/elaun layak, dibahagi 26 (pekerja bergaji bulan) atau hari sebenar bekerja (pekerja jam/hari), dibahagi 8 jam, kemudian didarab 1.5 (hari biasa), 2.0 (Ahad) atau 3.0 (cuti umum). Bonus masih dibayar tetapi tidak menaikkan kadar OT; bayaran cuti (Cuti Tahunan/Umum/Sakit) juga tidak termasuk dalam asas kiraan kadar OT walaupun masih dibayar seperti biasa. Tiada tetapan diperlukan untuk pekerja biasa: hari bekerja dikira secara automatik daripada log kerja harian dan rekod pengeluaran, manakala pekerja pada log bulanan secara automatik menggunakan pembahagi 26 (bergaji bulan). Perkara yang perlu dibuat: (1) bagi pekerja bergaji jam/hari yang direkod pada log BULANAN sahaja, isi ruangan \"Worked Days\" baharu pada log kerja bulanan — jika dibiarkan kosong, sistem menganggap pekerja itu bergaji bulan (÷26); (2) proses semula gaji Julai 2026 yang sedia ada supaya menggunakan kadar baharu. Item OT manual dan rekod Kerja Luar OT kekal pada nilai yang dikunci masuk, dan kod gaji OT tertentu boleh ditetapkan kepada \"Fixed\" untuk kekal pada kadar tetap. Halaman butiran gaji kini menunjukkan pecahan kiraan kadar OT bulan itu. Bulan Jun 2026 dan sebelumnya tidak berubah.",
    en: "Starting with the July 2026 payroll month, overtime (OT) rates are calculated automatically from that month's own earnings, following the Employment Act 1955, for all three companies (Tien Hock, Green Target, Jelly Polly). The calculation: salary + eligible incentives/commission/allowances, divided by 26 (monthly-salaried staff) or the actual days worked (hourly/daily staff), divided by 8 hours, then multiplied by 1.5 (ordinary day), 2.0 (Sunday) or 3.0 (public holiday). Bonus is still paid but no longer raises the OT rate; leave pay (Cuti Tahunan/Umum/Sakit) is also kept out of the OT rate basis while still being paid as usual. No setup is needed for typical employees: worked days are counted automatically from daily work logs and production records, while staff on monthly logs automatically use the 26-day divisor (monthly-salaried). What you need to do: (1) only for hourly/daily staff recorded on a MONTHLY log, fill in the new \"Worked Days\" field on the monthly work log — left empty, the system treats them as monthly-salaried (÷26); (2) reprocess the existing July 2026 payrolls so they use the new rates. Manual OT items and Kerja Luar OT records keep their keyed values, and specific OT pay codes can be set to \"Fixed\" to stay on a fixed rate. The payroll details pages now show the month's OT rate calculation breakdown. June 2026 and earlier are unchanged.",
  },
  {
    date: "2026-07-17",
