...
const CHANGELOG_ENTRIES: ChangelogEntry[] = [
  {
    date: "2026-07-30",
    ms: "Lebih banyak halaman kini mengingati tapisan dan kedudukan skrol anda. Apabila anda membuka satu rekod dan menekan Back, halaman senarai itu kembali seperti anda tinggalkan — carian, bulan, tapisan, nombor halaman dan kedudukan skrol semuanya kekal. Ini kini berkuat kuasa pada: Payments (Tien Hock, Jelly Polly, Green Target), senarai invois Jelly Polly, Credit/Debit/Refund Notes (semua syarikat), Chart of Accounts, Cash Bank-In (RV), General Purchases, Supplier Payments, Suppliers, Trial Balance, Balance Sheet, Income Statement, CoGM, Estimated P&L & Unit Cost, Customer, Staff (Tien Hock & Jelly Polly), Product, Job Category, Pay Code (Tien Hock & Jelly Polly), serta senarai Pelanggan dan Tong Green Target.",
    en: "More pages now remember your filters and scroll position. When you open a record and press Back, the list comes back exactly as you left it — search, month, filters, page number and scroll position all preserved. This now applies to: Payments (Tien Hock, Jelly Polly, Green Target), the Jelly Polly invoice list, Credit/Debit/Refund Notes (all companies), Chart of Accounts, Cash Bank-In (RV), General Purchases, Supplier Payments, Suppliers, Trial Balance, Balance Sheet, Income Statement, CoGM, Estimated P&L & Unit Cost, Customer, Staff (Tien Hock & Jelly Polly), Product, Job Category, Pay Code (Tien Hock & Jelly Polly), and the Green Target Customer and Dumpster lists.",
  },
  {
    date: "2026-07-30",
