...
const CHANGELOG_ENTRIES: ChangelogEntry[] = [
  {
    date: "2026-08-07",
    ms: "Butiran invois (Tien Hock): jurnal invois itu sendiri kini dipautkan dari pengepala invois, jadi anda boleh membuka jurnal jualan terus dari halaman invois. Setiap dokumen pelarasan (nota kredit/debit/bayaran balik) juga memautkan jurnalnya sendiri. Senarai bayaran tidak lagi memaparkan baris kutipan tunai automatik yang dibatalkan yang tertinggal daripada bil yang ditukar daripada Tunai kepada Invois, yang sebelum ini kelihatan seperti bayaran atau jurnal dibatalkan. Rujukan jurnal pada invois kini memaparkan rujukan yang anda masukkan (contohnya TR280726) dan bukannya nombor dalaman sistem.",
    en: "Invoice details (Tien Hock): the invoice's own journal entry is now linked from the invoice header, so you can open the sale journal directly from the invoice page. Each adjustment document (credit/debit/refund note) also links to its own journal. The payments list no longer shows a cancelled automatic cash-collection row left over from a bill that was changed from Cash to Invoice, which previously looked like a cancelled payment or journal. Journal references on the invoice now show the reference you keyed (for example TR280726) instead of an internal system number.",
  },
  {
    date: "2026-08-07",
