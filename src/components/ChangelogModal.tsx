...
const CHANGELOG_ENTRIES: ChangelogEntry[] = [
  ...
  {
    date: "2026-07-28",
    ms: "Material Stock: kos seunit kini boleh dikunci sehingga 4 tempat perpuluhan. Sebelum ini kos seperti 0.035 dibundarkan sendiri menjadi 0.04 apabila disimpan, menyebabkan nilai pelarasan tersalah kira. Selain itu, kotak kos seunit dan kuantiti pelarasan kini membenarkan anda menaip nombor perpuluhan terus — sebelum ini angka \"0\" dan titik perpuluhan hilang sebaik sahaja ditaip, jadi nilai seperti 0.005 memang tidak boleh dimasukkan. Kos yang anda taip kini disimpan tepat seperti yang dimasukkan dan dipaparkan penuh pada tooltip pengiraan. Nilai RM (pelarasan, baki akhir) kekal 2 tempat perpuluhan seperti biasa. Kos yang telah disimpan sebelum ini tidak berubah — jika ia sepatutnya 0.035, sila kunci semula.",
    en: "Material Stock: unit costs can now be keyed to 4 decimal places. Previously a cost like 0.035 was automatically rounded to 0.04 when saved, which made the adjustment value wrong. The unit cost and adjustment quantity boxes also let you type decimals straight through now — before this, the leading \"0\" and the decimal point were wiped as you typed, so a value like 0.005 simply could not be entered. The cost you type is now stored exactly as entered and shown in full in the calculation tooltip. RM values (adjustment, closing) stay at 2 decimals as before. Costs already saved are unchanged — if one should have been 0.035, please key it again.",
  },
  {
    date: "2026-07-28",
