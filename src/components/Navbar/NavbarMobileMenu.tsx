              ...
              <div className="mb-2">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-medium text-default-800 dark:text-gray-100">{t("Bookmarks")}</span>
                ...
                return (
                  <div key={category.name}>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        {category.icon && <category.icon size={20} stroke={1.5} />}
                        <span className="font-medium text-default-800 dark:text-gray-100">{t(category.name)}</span>
                      </div>
                      <IconChevronRight
                        size={18}
                        className={`text-default-400 dark:text-gray-500 transition-transform duration-200 ${
          ...
          <div className="border-t border-default-200 dark:border-gray-700 p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium text-default-800 dark:text-gray-100 text-sm">{user?.id || t("User")}</p>
                  <p className="text-xs text-default-500 dark:text-gray-400">{t("Logged in")}</p>
                </div>
              </div>
              <button
