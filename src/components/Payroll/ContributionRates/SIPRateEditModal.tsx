// src/components/Payroll/ContributionRates/SIPRateEditModal.tsx
...
const SIPRateEditModal: React.FC<SIPRateEditModalProps> = ({
  isOpen,
  onClose,
  rate,
}) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await api.put(`/api/contribution-rates/sip/${rate.id}`, payload);
...
export default SIPRateEditModal;
