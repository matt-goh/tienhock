...
// PDFs generated by @react-pdf/renderer reference the standard-14 fonts
// (Helvetica, Courier) by name without embedding them; pdfjs needs the
// bundled standard font data to rasterize that text.
const standardFontDataUrl = path.join(
  path.dirname(url.fileURLToPath(import.meta.resolve("pdfjs-dist/legacy/build/pdf.mjs"))),
  "..",
  "..",
  "standard_fonts"
) + path.sep;
