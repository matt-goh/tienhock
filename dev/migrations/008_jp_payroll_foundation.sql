-- 008_jp_payroll_foundation.sql (v2 — OWN CATALOGUE design)
-- Jelly Polly payroll & production foundation.
--
...
-- nothing is shared with the Tien Hock catalogue tables anymore.
-- Products remain shared (public.products, type='JP').
--
-- Section 0 cleans up the previous shared-catalogue build if present (dev DBs
-- that ran the v1 migration); it is a no-op on a clean database.
