...
-- Phase V2: exact 2026 legacy-report opening-stock and APPX bridge.
--
-- Development sign-off boundary:
...
--
-- Monthly closing stock is deliberately NOT part of this migration (Phase V3).
-- The script accepts only the exact audited fresh state or its exact final
-- state. A final-state rerun verifies and performs zero writes.
...
BEGIN
  ...
  IF (
       ...
       2821::bigint,
       '4bdea1a3bc50008593327931b856ec6b'::text
     ) THEN
  ...
  v_is_fresh :=
    ...
    AND v_full_mapping_fingerprint =
      '41a5aa06f2fce391bce966b25837b20c'
  ...
  v_is_final :=
    ...
    AND v_full_mapping_fingerprint =
      '40749117fe04a6ab0a83652ce07f18c9'
    AND v_notes_fingerprint =
...
BEGIN
  ...
  IF (
       ...
       2821::bigint,
       '4bdea1a3bc50008593327931b856ec6b'::text,
       '40749117fe04a6ab0a83652ce07f18c9'::text
     ) THEN
