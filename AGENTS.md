...
- `greentarget.driver_trips` - id, driver_id, year, month, trip_count, completed_rental_ids, auto_calculated, notes, created_at, updated_at (UNUSED since 2026-06-10: the Driver Trips entry page/routes were removed; DRIVER pay is derived directly from rentals during payroll processing)
