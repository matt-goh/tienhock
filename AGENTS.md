...
- `greentarget.employee_payrolls` - id, monthly_payroll_id, employee_id, job_type, section, gross_pay, net_pay, status, created_at, employee_job_mapping, digenapkan, setelah_digenapkan (rounding: setelah_digenapkan = CEIL(net_pay - mid-month advance), mirrors TH payroll)
