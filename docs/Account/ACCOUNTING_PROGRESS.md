...
| Trial Balance / Income Statement / Balance Sheet / CoGM (+ PDFs) | ✅ **V2 development boundary verified 20 Jul 2026** — 880/880 Jan–May TB rows exact, May BS balanced at RM5,389,607.26 before closing stock, opening inventory included once, Note 22/7 journal-authoritative, BM/EN Guide updated. Still single-period and without prior-year comparatives; monthly closing stock remains V3 | [financial-reports.js](../../src/routes/accounting/financial-reports.js), [Reports/](../../src/pages/Accounting/Reports/) |
...
> **Update 20 Jul 2026:** the Jan–May legacy ledger import remains immutable and verified in production. The scan-verification V2 package is implemented and verified on development only: 63 CS anchors were converted to explicit zero fences, 62 evidenced OS anchors were added, 125 APPX mappings were corrected, and the narrow fiscal-opening report engine now balances the May books at RM5,389,607.26. See [LEGACY_REPORT_VERIFICATION_PLAN.md](LEGACY_REPORT_VERIFICATION_PLAN.md) and [LEGACY_REPORT_RECONCILIATION.md](LEGACY_REPORT_RECONCILIATION.md). Production V2 remains a separate approval; V3 owns monthly closing stock and full RM6,097,691.11 May parity.

Ranked; full rationale in [ACCOUNTING_GAP_ANALYSIS.md](ACCOUNTING_GAP_ANALYSIS.md) (statuses refreshed 2 Jul 2026):

1. **Monthly closing stock (V3 / remaining part of 1A-7).** ✅ The evidenced 2026 opening gap is closed on development and exact fiscal opening stock is wired into TB/BS/IS/CoGM without a synthetic journal. Next, design the user-managed monthly closing-stock source; do not generalise the V2 exact-1-January rule or treat June checkpoints as P&L opening stock.
...
- TB/BS/IS/CoGM: 2026 opening stock is included on development, but there is no monthly closing-stock source, no comparatives, Note 5 remains one lump, and there is no general period-close workflow.
